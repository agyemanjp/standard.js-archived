...
exports.deleteAsync = exports.getAsync = exports.putAsync = exports.postAsync = exports.checkStatusCode = exports.asQueryParams = exports.MimeType = exports.HttpStatusCodes = void 0;
...
const getResponseHandler = (resolve, reject, opts) => ((err, response) => {
    if (err) {
...
function getAsync(request, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            request_1.get({
                uri: `${new string_1.stdString(request.uri).trimRight("/")}${queryParams}`,
